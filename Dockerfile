...
RUN apt-get -q -y install cmake libhdf5-dev protobuf-compiler libgl2ps-dev libfreetype6-dev libxml2-dev libpugixml-dev zlib1g-dev libpng-dev libjpeg-dev libtiff5-dev
